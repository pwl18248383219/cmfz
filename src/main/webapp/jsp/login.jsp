...
<head>
    ...
    <script type="text/javascript">
        function changeImage(){
            $("#imgVcode").prop("src","${pageContext.request.contextPath }/admin/createImg?xx="+new Date().getTime());
        }
...
<body style=" background: url(../img/4.jpg); background-size: 100%;">
                ...
                <div class="Captcha-operate">
                    <div class="Captcha-imageConatiner">
                        <a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
                            <img id="imgVcode" src="${pageContext.request.contextPath }/admin/createImg" class="Ucc_captcha Captcha-image" onClick="changeImage()">
                        </a>
